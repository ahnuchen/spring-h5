...
public class FilesController extends BaseController {
  ...
  @GetMapping("/upload/theme/{themeId}")
  public CommonReturnType getFiles(@PathVariable String themeId, @RequestParam String fileType) throws BusinessException {
    return CommonReturnType.success(filesRepository.findAllByThemeIdAndFileType(themeId, fileType));
  }
}
